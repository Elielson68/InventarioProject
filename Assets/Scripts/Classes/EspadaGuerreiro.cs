...
{
    public class EspadaGuerreiro : MonoBehaviour, IEquipamento
    {

        public EspadaGuerreiro(GameObject spawnPosition)
        {
            ...
            EspadaGuerreiro component = spriteGameObject.AddComponent<EspadaGuerreiro>();
            component.Nome = Nome;
            component.Tipo = Tipo;
        ...
        {
            EspadaGuerreiro other = (EspadaGuerreiro)this.MemberwiseClone();
            return other;
        }
