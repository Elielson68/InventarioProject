...
Agora já temos uma coisa mais concreta, uma interface equipamento que irá conter os atributos, uma classe abstrata ferreiro que conterá um método que devolverá um objeto do tipo equipamento,
 ...
 Agora para finalizar, uma pequena explicação sobre a última classe <i>alone</i> que é a Inventario. Essa classe irá conter duas listas, uma para os itens gerais e outra específica para equipamentos e conterá alguns métodos mais complexos que irei explicar abaixo na codificação.
